...
async def gen_link(app, chat_username):
    link = await app.export_chat_invite_link(chat_username)
    return link

async def subscribe(app, message):
    update_channel = CHANNEL_USERNAME
...
async def get_seconds(time_string):
    ...
    time_multipliers = {"s": 1, "min": 60, "hour": 3600, "day": 86400, "month": 86400 * 30, "year": 86400 * 365}
